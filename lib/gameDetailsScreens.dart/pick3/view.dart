// ignore_for_file: use_key_in_widget_constructors, must_be_immutable, non_constant_identifier_names, unnecessary_this, prefer_collection_literals

import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';
import 'package:internshippractice/Constants/colors.dart';
import 'package:internshippractice/services/api_services/post_service.dart';
import 'package:internshippractice/services/api_services/urls.dart';
...
class Pick3Page extends StatelessWidget {
  final logic = Get.put(Pick3Logic());

  final state = Get.find<Pick3Logic>().state;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<Pick3Logic>(builder: (pick3) {
      return Scaffold(
